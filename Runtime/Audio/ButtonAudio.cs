...
namespace GGL.Audio
{
    ...
    [AddComponentMenu(Settings.NAME + "/UI/Audio/Button Audio")]
    [HelpURL(Settings.ARTICLE_URL + "audio" + Settings.COMMON_EXT + "#configuration")]
    public class ButtonAudio : MonoBehaviour
    {
        ...
        /// </value>
        [ShowIf(nameof(mode), Mode.DEFAULT)] [SerializeField] protected float volume = 1f;
        /// <value>
        /// In DEFAULT mode, audio file to play.
        /// </value>
        [ShowIf(nameof(mode), Mode.DEFAULT)] [SerializeField] protected AudioClip clip;
        
        /// <value>
        /// In CUSTOM mode, AudioSource to play.
        /// </value>
        [ShowIf(nameof(mode), Mode.CUSTOM)] [SerializeField] protected AudioSource source;


        /// <inheritdoc cref="MonoBehaviour" />
        [ExcludeFromDocFx]
        protected virtual void Awake() => GetComponent<Button>().onClick.AddListener(PlaySound);
