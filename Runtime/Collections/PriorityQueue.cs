...
namespace GGL.Collections
{
    ...
    public class PriorityQueue<TElement, TPriority>
    {
        ...
        /// </summary>
        private const int LOG2_ARITY = 2;
        
        private const string INVALID_OPERATION_EMPTY_QUEUE = "Invalid Operation : Queue is empty.";
        private const int ARRAY_MAX_LENGTH = 2147483591;

#if DEBUG
        static PriorityQueue()
        {
            Debug.Assert(LOG2_ARITY > 0 && Mathf.Pow(2, LOG2_ARITY).Round() == ARITY);
        }
#endif
        ...
        public TElement Peek()
        {
            if (_size == 0)
            {
                throw new InvalidOperationException(INVALID_OPERATION_EMPTY_QUEUE);
            }
        ...
        private void Grow(int minCapacity)
        {
            ...
            int newcapacity = GROW_FACTOR * _nodes.Length;
            ...
            newcapacity = Mathf.Max(newcapacity, _nodes.Length + MINIMUM_GROW);
        ...
        /// </summary>
        private static int GetParentIndex(int index) => (index - 1) >> LOG2_ARITY;

        /// <summary>
        /// Gets the index of the first child of an element.
        /// </summary>
        private static int GetFirstChildIndex(int index) => (index << LOG2_ARITY) + 1;
        ...
        [DebuggerDisplay("Count = {Count}")]
        public sealed class
            UnorderedItemsCollection : IReadOnlyCollection<(TElement Element, TPriority Priority)>, ICollection
        {
            ...
            IEnumerator<(TElement Element, TPriority Priority)>
                IEnumerable<(TElement Element, TPriority Priority)>.GetEnumerator() => GetEnumerator();
